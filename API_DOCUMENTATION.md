# Callex AI — Complete Developer API Documentation

> **Version:** 3.0 &nbsp;|&nbsp; **API Base URL:** `http://62.171.170.48:4500` &nbsp;|&nbsp; **Last Updated:** March 17, 2026
...
curl -X POST http://62.171.170.48:4500/api/v1/agents \
  ...
  -d '{
    ...
    "openingLine": "Hello! I am calling regarding an exclusive offer.",
    "voice": "MF4J4IDTRo0AxOO4dpFR",
    "temperature": 0.6,
    "maxDuration": 15
  }'
...
Triggers CX-Model AI to generate a summary of the call transcript.
...
| `language` | string | `"en-US"` | Language code (`hi-IN`, `en-US`) |
